...
from util.generators import SliceSelectionSequence
from modeltrain.densenet_regression import DenseNet


def train(data_dir, model_dir, epochs=100, name=None, batch_size=256,
          load_weights=None, gpus=1, learning_rate=0.01, threshold=10.0,
    ...
    train_jitter = 356 
    #1274  
    # default 1000 times of image augmentation for each epoch
    val_jitter = 41 
    #313  
    # default 50 times of image augmentation for each epoch
    ...
    parallel_model.compile(optimizer=Adam(learning_rate=learning_rate), loss=loss)
    print('Starting training...')
  #  history = parallel_model.fit_generator(train_generator, epochs=epochs,
